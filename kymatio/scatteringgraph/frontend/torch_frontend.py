...
class ScatteringTorchGraph(ScatteringTorch, ScatteringBaseGraph):
    def __init__(self, J, Q=2, A=None, normalize=True, max_order=2, backend='torch'):
        ...
        ScatteringBaseGraph.__init__(**locals())
    ...
    def scattering(self, input):
        ...
        #TODO add checks 
        # see https://github.com/kymatio/kymatio/blob/master/kymatio/scattering2d/frontend/torch_frontend.py#L82
        ...
        # see https://github.com/kymatio/kymatio/blob/master/kymatio/scattering2d/frontend/torch_frontend.py#L110
        return S
